...
public class Test {
	...
	public static void main(String[] args) {
		...
		UIManager.put("OptionPane.background",new ColorUIResource(255,191,0)); //krāsa
		UIManager.put("Panel.background",new ColorUIResource(255,191,0)); //krāsa
	...
	public static void jautajumi() {
	    ...
	    String[] quizQuestion = {"Valoda Java ir viena no ... valodām","Kas pieder pie strukturētajiem mainīgajiem?", //jautājumi
	    ...
	    for(x = 0; x < 10; x++) { //10 jautājumus
            ...
            if(playerAnswerString.toUpperCase().equals("AD")){ //spēja rakstīt maziem burtiem un atbildes pārbaude
